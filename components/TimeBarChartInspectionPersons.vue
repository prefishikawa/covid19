...
import { GraphDataType } from '@/utils/formatNumberOfInspectionsGraph'
        ...
        datasets: [
          {
            label: this.dataKind,
            data: this.chartData.map(d => {
              return d.cumulativeAdminInspection
            }),
            backgroundColor: '#1b4d30',
            borderColor: '#1b4d30',
            borderWidth: 1
          },
          {
            label: this.dataKind,
            data: this.chartData.map(d => {
              return d.cumulativeInsuranceCoverage
            }),
            backgroundColor: '#c5e2c6',
            borderColor: style.strokeColor,
            borderWidth: 1
